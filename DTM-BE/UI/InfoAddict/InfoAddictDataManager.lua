...
function SavePlayerDataTurnEnd(turn)
  ...
  for iPlayerLoop = 0, GameDefines.MAX_MAJOR_CIVS-1, 1 do
    local pPlayer = Players[iPlayerLoop];
      ...
      stats.happiness = pPlayer:GetExcessHealth();
      stats.culture = pPlayer:GetTotalCulturePerTurn();
      ...
      stats.totalgold = pPlayer:GetEnergy();
	    stats.affinity = computeAffinityLevelSum(iPlayerLoop);
	  ...
	  thisdata = thisdata .. " " .. typeCodes.affinity .. ":" .. stats.affinity;
...
-- A few informational messages that are meant to be displayed when the mod fires up.
