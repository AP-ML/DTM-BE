...
Events.LeavingLeaderViewMode.Add( OnLeaderheadPopupClosed );

function OnLeaderheadShow()
	Controls.SciencePerTurn:ClearCallback( Mouse.eLClick );
	Controls.CivilopediaButton:ClearCallback( Mouse.eLClick );
	Controls.MenuButton:ClearCallback( Mouse.eLClick );
	Controls.CultureString:ClearCallback( Mouse.eLClick );
	Controls.EnergyPerTurn:ClearCallback( Mouse.eLClick );
	Controls.InternationalTradeRoutes:ClearCallback( Mouse.eLClick );
end
--LuaEvents.LeaderheadRootShow.Add( OnLeaderheadShow );
Events.AILeaderMessage.Add( OnLeaderheadShow );