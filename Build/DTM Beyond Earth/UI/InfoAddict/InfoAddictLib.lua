...
function InfoAddictModGUID()
  return "b33e7351-356e-4388-a741-1484eea9c637";
end;
...
-- Function that counts up the affinity level of Purity, Supremacy, and Harmony for each player, then returns the sum.
function computeAffinityLevelSum(playerId)
	local i=0;
	local player = Players[playerId];
	for a in GameInfo.Affinity_Types() do
		i = i + player:GetAffinityLevel(a.ID);
	end
	return i;
end 
